"""THE SEO MACHINE — writes articles that answer what this business's customers search for, checks
...
_state.register_schema("seo_machine", _DDL)
...
def _seo_publish_tick():
    from . import job
    return job.periodic()


_register_periodic(_seo_publish_tick, interval_s=60, name="seo_publish")
